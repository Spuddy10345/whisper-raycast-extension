      ...
      await new Promise<void>((resolve, reject) => {
        const request = (url: string) => {
           ...
           https.get(url, (response) => {
             ...
             // Handle redirects
             if (response.statusCode && (response.statusCode >= 301 && response.statusCode <= 307) && response.headers.location) {
             ...
             fileStream.on('finish', () => {
               ...
               fileStream.close((closeErr) => { // Ensure file descriptor closed
                 if (closeErr) {
