    ...
    useEffect(() => {
      async function loadHistory() {
        try {
          ...
          console.log(`History Command: Direct LocalStorage data: ${rawData ? rawData.substring(0, 150) + '...' : 'null or empty'}`);
                  ...
                  <List.Item.Detail
                    ...
                    metadata={
                      <List.Item.Detail.Metadata>
                        ...
                        <List.Item.Detail.Metadata.Label icon={Icon.Text} title="Characters" text={item.text.length.toString()} />
                      </List.Item.Detail.Metadata>
                    }
                  />
                }
